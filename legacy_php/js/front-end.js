  ...
  !(function(n) {
      ...
      if (e) {
        for (
          l = (e = e.split("/")).length - 1,
            c.nodeIdCompat && m.test(e[l]) && (e[l] = e[l].replace(m, "")),
            "." === e[0].charAt(0) &&
              g &&
    ...
    (l = function(e, t) {
      ...
      (r = function(e, t, i, r) {
        var o,
          ...
          w = [],
          F = typeof i;
        if (((p = _((r = r || e))), "undefined" === F || "function" === F)) {
          for (
            ...
            if ("require" === (c = (h = l(t[m], p)).f)) w[m] = a.require(e);
            else if ("exports" === c) (w[m] = a.exports(e)), (R = !0);
            else if ("module" === c) o = w[m] = a.module(e);
            else if (g(s, c) || g(d, c) || g(f, c)) w[m] = b(c);
            else {
              if (!h.p) throw new Error(e + " missing " + c);
              h.p.load(h.n, v(r, !0), y(c), {}), (w[m] = s[c]);
            }
      ...
      (e = t = o = function(e, t, i, s, d) {
        if ("string" == typeof e) return a[e] ? a[e](t) : b(l(e, _(t)).f);
        if (!e.splice) {
      ...
      var t = Backbone.Collection.extend({
        ...
        initialize: function(e, t) {
          (this.options = t),
            ...
            nfRadio
              .channel("fields")
              .reply("get:firstFieldByOrder", this.getFirstFieldByOrder);
        },
        validateFields: function() {
            ...
            function(e) {
              if ("repeater" === e.get("type")) {
                const t = nfRadio
                  ...
                  .request(
                    "get:repeaterFieldsModelsArrayByForm",
                    e.get("formID")
                  );
                _.each(t, function(e) {
                  e.set("clean", !1),
          ...
          var e = nfRadio
            .channel("form-" + this.models[0].get("formID"))
            .request("get:form");
          _.size(e.get("fieldErrors")) > 0 &&
            nfRadio
              .channel("submit")
              .request(
                "focus:firstInvalidInput",
                Object.keys(e.get("fieldErrors"))
              );
        },
        showFields: function() {
      ...
      return Marionette.Object.extend({
        ...
        emailKeyup: function(e, n, r) {
          ...
          var o = jQuery(e).val(),
            l = n.get("id");
          if (0 == o.length)
            nfRadio.channel("fields").request("remove:error", l, i);
            ...
            var a = nfRadio.channel("fields").request("get:field", l),
              s = nfRadio.channel("app").request("get:form", a.get("formID"));
            nfRadio
              .channel("fields")
              .request(
                "add:error",
    ...
    i("controllers/changeDate", [], function() {
      ...
      return Marionette.Object.extend({
        ...
        onChangeModelValue: function(e) {
          var t = moment.locale();
          moment.locale("ninja-forms"), this.dateChange(e), moment.locale(t);
        },
        onBlurField: function(e, t) {
          var i = moment.locale();
          moment.locale("ninja-forms"), this.dateChange(t), moment.locale(i);
        },
          ...
          if (0 < n.length)
            if (moment(n, r).isValid())
              ...
              var o = nfRadio.channel("fields").request("get:field", i),
                l = nfRadio.channel("app").request("get:form", o.get("formID"));
              nfRadio
                .channel("fields")
                .request(
                  "add:error",
                  i,
                  t,
                  l.get("settings").changeDateErrorMsg
                );
            }
        ...
        dateKeyup: function(e, i, n) {
          ...
          var r = jQuery(e).val(),
            ...
            l = i.get("date_format"),
            a = moment.locale();
          if ((moment.locale("ninja-forms"), 0 == r.length))
            nfRadio.channel("fields").request("remove:error", o, t);
          else if (moment(r, l).isValid() || i.get("clean"))
            moment(r, l).isValid() &&
              (nfRadio.channel("fields").request("remove:error", o, t),
            ...
            nfRadio
              .channel("fields")
              .request("add:error", o, t, d.get("settings").changeDateErrorMsg),
      ...
      return Marionette.Object.extend({
            ...
            (_.each(
              ...
              function(l, a) {
                this.show_option_labels
                  ...
                  Array.isArray(this.value) &&
                    ((Array.isArray(this.value[0]) &&
                      -1 !== _.indexOf(this.value[0], l.value)) ||
                      _.indexOf(this.value, l.value)) &&
                    (t = !0),
                  l.value == this.value && (t = !0),
                  void 0 === l.visible && (l.visible = !0),
                  "horizontal" === i.list_orientation &&
                    r <= n &&
                    ((l.styles =
                      "margin:auto;grid-column: " + r + "; grid-row = " + o),
                    r === n ? ((r = 1), (o += 1)) : (r += 1)),
                  (l.image_type = i.image_type),
                  (l.fieldID = this.id),
                  (l.classes = this.classes),
                  (l.index = a);
                var s = !1;
                Array.isArray(this.value) && 0 < this.value.length
                  ? (-1 === _.indexOf(this.value[0].split(","), l.value) &&
                      -1 === _.indexOf(this.value, l.value)) ||
                    (s = !0)
                  : ((_.isArray(this.value) || l.value != this.value) &&
                      (1 != l.selected ||
                        !this.clean ||
                  ...
                  (l.selected = s),
                  (l.isSelected = s),
                  (l.required = this.required),
                  (l.maybeFilterHTML = this.maybeFilterHTML);
                var d = nfRadio
                  .channel("app")
        ...
        renderOtherText: function() {
          if ("nf-other" == this.currentValue || !this.valueFound) {
            ...
            return nfRadio
              .channel("app")
              .request("get:template", "#tmpl-nf-field-listimage-other-text")(
              e
            );
          }
        },
      ...
      return Marionette.Object.extend({
        ...
        renderOtherText: function() {
          if ("nf-other" == this.currentValue || !this.valueFound) {
            ...
            return nfRadio
              .channel("app")
              .request("get:template", "#tmpl-nf-field-listradio-other-text")(
              e
            );
          }
        },
    ...
    i("controllers/fieldNumber", [], function() {
      return Marionette.Object.extend({
        ...
        validateMinMax: function(e, t) {
          ...
          if (r && n < r) {
            var a = nfRadio.channel("fields").request("get:field", t.get("id")),
              s = nfRadio.channel("app").request("get:form", a.get("formID"));
            nfRadio
              .channel("fields")
              .request(
          ...
          if (o && n > o) {
            (a = nfRadio.channel("fields").request("get:field", t.get("id"))),
              (s = nfRadio.channel("app").request("get:form", a.get("formID")));
            nfRadio
              .channel("fields")
              .request(
          ...
          if (l && n && 0 != d % c) {
            ...
            nfRadio
              ...
              .request(
                ...
                t.get("id"),
                "number-step",
                s.get("settings").fieldNumberIncrementBy + l
              );
          } else
            nfRadio
              .channel("fields")
    ...
    i("controllers/confirmField", [], function() {
      ...
      return Marionette.Object.extend({
        ...
        changeValue: function(i) {
          ...
          if ("" == n.get("value") || n.get("value") == r.get("value"))
            ...
            var l = nfRadio.channel("fields").request("get:field", o),
              a = nfRadio.channel("app").request("get:form", l.get("formID"));
            nfRadio
              .channel("fields")
              .request(
                "add:error",
                o,
                t,
                a.get("settings").confirmFieldErrorMsg
              );
          }
        },
        confirmKeyup: function(e, i, n) {
          ...
          if (void 0 !== o)
            if ("" == s)
              nfRadio.channel("fields").request("remove:error", l, t);
            else if (r == a)
              nfRadio.channel("fields").request("remove:error", l, t);
            else {
              var d = nfRadio.channel("fields").request("get:field", l),
    ...
    i("controllers/submitButton", ["controllers/submitButton"], function(e) {
      return Marionette.Object.extend({
        ...
        click: function(e, t) {
          ...
          _.size(i.get("fieldErrors")) > 0 &&
            nfRadio
              .channel("submit")
              .request(
                "focus:firstInvalidInput",
                Object.keys(i.get("fieldErrors"))
              ),
      ...
      return Marionette.Object.extend({
        initialize: function() {
          this.listenTo(
            ...
            nfRadio
              .channel("submit")
              .reply("focus:firstInvalidInput", this.focusFirstInvalidInput);
        },
        ...
        focusFirstInvalidInput: function(e) {
          const t = nfRadio
            .channel("fields")
            .request("get:firstFieldByOrder", e);
          document.getElementById("nf-field-" + t).focus();
        }
      });
    }),
      ...
      return Marionette.Object.extend({
        ...
        actionSubmit: function(e) {
          if (
            ...
            const a = e.data.actions.success_message.replace(
              /(<([^>]+)>)/gi,
              ""
            );
            i.attr("tabindex", "0"),
      ...
      return Marionette.Object.extend({
        ...
        renderProduct: function() {
          switch (this.product_type) {
            case "user":
              return nfRadio
                .channel("app")
                .request("get:template", "#tmpl-nf-field-textbox")(this);
            case "hidden":
              return nfRadio
                .channel("app")
                .request("get:template", "#tmpl-nf-field-hidden")(this);
            case "dropdown":
              return nfRadio
                .channel("app")
                .request("get:template", "#tmpl-nf-product-dropdown")(this);
            default:
              return nfRadio
                .channel("app")
                .request("get:template", "#tmpl-nf-product-single")(this);
          }
        },
        renderProductQuantity: function() {
          if (1 == this.product_use_quantity)
            return nfRadio
              .channel("app")
              .request("get:template", "#tmpl-nf-product-quantity")(this);
        },
        renderOptions: function() {
          var e = this,
            t = "";
      ...
      return Marionette.Object.extend({
        ...
        onFormLoaded: function(e) {
          ...
          for (var r in t) {
            var o = t[r],
              l = o.get("id");
            if ("product" == o.get("type")) i[l] = o;
            else if ("quantity" == o.get("type")) {
              n[(a = o.get("product_assignment"))] = o;
            }
          }
          for (var a in i) {
            var s = i[a],
      ...
      return Marionette.Object.extend({
        ...
        setupCalc: function(e) {
          ...
          try {
            ...
            e.set(
              "value",
              Number(t.eval(this.localeDecodeEquation(n))).toFixed(e.get("dec"))
            );
          } catch (e) {
            console.log(e);
          }
        ...
        getCalcValue: function(e) {
          ...
          var n = new r(
            ...
            l = n.numberEncoder(i);
          return (
            (t = void 0 !== o && jQuery.isNumeric(o) ? l : 0),
            e.get("visible") || (t = 0),
            t
          );
        },
        ...
        changeField: function(e, t) {
          ...
          try {
            ...
            e.set(
              "value",
              Number(t.eval(this.localeDecodeEquation(r))).toFixed(e.get("dec"))
            );
          } catch (e) {
            ...
            _.each(this.displayFields[e.get("name")], function(i) {
              ...
              _.each(o, function(e) {
                var r = e
                  ...
                  l = new RegExp(e, "g"),
                  a = o.get("value");
                void 0 !== a && (a = t.applyLocaleFormatting(a, o)),
                  (n =
                    "html" === i.get("type")
                      ? n.replace(
                          l,
                          '<span data-key="calc:' + r + '">' + a + "</span>"
                        )
                      : a);
              }),
                i.set("value", n),
        ...
        changeCalc: function(e, t) {
          ...
          try {
            ...
            e.set(
              "value",
              Number(t.eval(this.localeDecodeEquation(i))).toFixed(e.get("dec"))
            );
          } catch (e) {
            console.log(e);
          }
    ...
    i("controllers/fieldDate", [], function() {
      return Marionette.Object.extend({
        ...
        initModel: function(e) {
          this.registerFunctions(e), this.registerMomentLocale();
        },
        ...
        initDatepicker: function(e) {
          ...
          var n = {
            ...
            parseDate: function(e, t) {
              ...
              var n = moment(e, t, !0).toDate();
              return moment.locale(i), n;
            },
            formatDate: function(e, t, i) {
              var n = moment.locale();
              moment.locale("ninja-forms");
              var r = moment(e).format(t);
              return moment.locale(n), r;
            },
            dateFormat: i,
            altFormat: i,
            altInput: !0,
            ...
            onReady: (e, i, n) => {
              n.altInput.setAttribute(
                "aria-labelledby",
                jQuery(t).attr("aria-labelledby")
              );
            }
          };
        ...
        beforeSubmit: function(e) {
          ...
          let l = { date: o, hour: t, minute: i, ampm: n };
        ...
        convertDateFormat: function(e) {
          return (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = e.replace(
            "D",
            "ddd"
          )).replace("d", "DD")).replace("l", "dddd")).replace(
            "j",
            "D"
          )).replace("N", "")).replace("S", "")).replace("w", "d")).replace(
            "z",
            ""
          )).replace("W", "W")).replace("M", "MMM")).replace(
            "F",
            "MMMM"
          )).replace("m", "MM")).replace("n", "M")).replace("t", "")).replace(
            "L",
            ""
          )).replace("o", "YYYY")).replace("Y", "YYYY")).replace(
            "y",
            "YY"
          )).replace("a", "")).replace("A", "")).replace("B", "")).replace(
            "g",
            ""
          )).replace("G", "")).replace("h", "")).replace("H", "")).replace(
            "i",
            ""
          )).replace("s", "")).replace("u", "")).replace("v", "")).replace(
            "e",
            ""
          )).replace("I", "")).replace("O", "")).replace("P", "")).replace(
            "T",
            ""
          ...
          try {
            nfRadio.channel("form-" + e).trigger("disable:submit", t),
              grecaptcha.ready(function() {
                grecaptcha
                  .execute(t.get("site_key"), { action: "register" })
                  .then(function(i) {
                    t.set("value", i),
              ...
              t.collection.models.forEach(e => {
                ...
                nfRadio
                  ...
                  .request(
                    ...
                    t.collection.options.formModel.get("settings")
        ...
        nf_build_default_consent_action: function(e, t, i, n) {
          if (
            ...
            r.setAttribute("id", "nf_recaptcha_consent_event"),
              (r.innerText += e.collection.options.formModel.get(
                "settings"
        ...
        onRender: function() {
          if (
            ...
            if (
              ...
              var n = jQuery("<div/>")
                  .html(t.get("currencySymbol"))
                  .text(),
                r = {
                  digitGroupSeparator: (i = jQuery("<div/>")
                    .html(i)
                    .text()),
        ...
        templateHelpers: function() {
          ...
          return {
            renderElement: function() {
              ...
              return nfRadio
                .channel("app")
                .request("get:template", "#tmpl-nf-field-" + e)(this);
            },
            renderLabel: function() {
              return nfRadio
                .channel("app")
                .request("get:template", "#tmpl-nf-field-label")(this);
            },
            ...
            renderWrapClass: function() {
              ...
              return (
                ...
                void 0 !== this.old_classname &&
                  0 < this.old_classname.trim().length &&
            ...
            renderClasses: function() {
              ...
              return (
                ...
                void 0 !== this.element_class &&
                  0 < this.element_class.trim().length &&
      ...
      return Marionette.ItemView.extend({
        ...
        updateCount: function(e, t) {
          ...
          if (
            ...
            r > l && jQuery(e).val(n.slice(0, l).join(" "));
          }
          this.render();
        },
        templateHelpers: function() {
          ...
          onRender: function() {
            ...
            if (
              ...
              void 0 !== this.model.get("input_limit") &&
                "" != this.model.get("input_limit").trim())
            ) {
              ...
              renderContainerClass: function() {
                ...
                return (
                  ...
                  void 0 !== this.container_class &&
                    0 < this.container_class.trim().length &&
        ...
        return Marionette.LayoutView.extend({
          ...
          initialize: function() {
            (this.collection = this.model.get("sets")),
              this.listenTo(
                nfRadio.channel("field-repeater"),
                "rerender:fieldsets",
                this.render
              );
          },
          ...
          addSet: function() {
            nfRadio
              .channel("field-repeater")
              .trigger("add:fieldset", this.model.id);
          },
          beforeSubmit: function() {
      ...
      return Marionette.Object.extend({
        ...
        submit: function(e) {
          ...
          var n = e.get("id"),
            r = {};
          _.each(e.get("fields").models, function(e) {
            var t = { value: e.get("value"), id: e.get("id") };
            r[e.get("id")] =
          ...
          var o = e.get("extra"),
            l = e.get("settings");
          delete l.formContentData;
          var a = JSON.stringify({ id: n, fields: r, settings: l, extra: o }),
            s = {
    ...
    return Backbone.Model.extend({
      initialize: function(e, t) {
        (this.repeaterFieldModel = t.repeaterFieldModel),
          ...
          nfRadio
            .channel("field-repeater")
            .reply("get:repeaterModels", this.getAllRepeaterFieldsModels, this),
          nfRadio
            .channel("field-repeater")
            .reply(
              "get:repeaterFieldsetsByForm",
              this.getAllFieldsetsByForm,
              this
            ),
          nfRadio
            .channel("field-repeater")
            .reply(
              "get:repeaterFieldsModelsArrayByForm",
              this.getAllFieldsModelsArrayByForm,
              this
            ),
          this.listenTo(
            nfRadio.channel("field-repeater"),
            "set:repeaterModels",
            this.setRepeaterModels
          ),
          this.listenTo(
            nfRadio.channel("field-repeater"),
            "reset:repeaterFieldsModelsByFieldsets",
            this.resetRepeaterFieldsModelsByFieldsets
          ),
          this.listenTo(
            nfRadio.channel("field-repeater"),
            "set:value",
            this.setAllRepeatersValues
          );
      },
      ...
      initAllRepeaterFieldsModels: function(e, t) {
        const i = t.repeaterFieldModel.get("formID"),
          ...
          o = e.fields.models;
        let l = n.find(e => e.id === r && e.form === i);
        l
          ? (l.fields = l.fields.concat(o))
          : n.push({ form: i, id: r, fields: o }),
      ...
      resetRepeaterFieldsModelsByFieldsets: function(e) {
        _.each(e, e => {
          ...
          o &&
            (_.each(t.models, e => {
              const t = o.fields.findIndex(
                t => t.id === e.id && t.cid !== e.cid
              );
      ...
      getRepeaterFields: function(e) {
        ...
        return void 0 === i && (i = this.reverseResearchFieldsetModel(e, t)), i;
      },
          ...
          _.each(e, function(e) {
            ...
            if (t.length > 0) {
              ...
              _.each(t, function(t) {
                ...
                (e[n] = { value: i, id: n }),
                  "file_upload" === t.get("type") &&
                    t.get("value") &&
                    (e[n].files = t.attributes.files);
              }),
                i.set("isUpdated", !1),
        ...
        return Backbone.Collection.extend({
          ...
          initialize: function(e, t) {
            (this.options = t),
              ...
              nfRadio
                .channel("field-repeater")
                .reply("get:fieldsets", this.getFieldSets, this);
          },
          addSet: function(e = !1) {
            if (e) {
              const i =
                this.options.repeaterFieldModel.id === e &&
              ...
              if (i) {
                ...
                this.add({ fields: e }, { repeaterFieldModel: i });
              }
            }
            this.sortIDs();
          },
              ...
              e.set("index", t + 1),
                _.each(i.models, function(e) {
                  const i = String(e.id).split("_")[0],
                    n =
                      String(i).split(".").length > 1 &&
                      String(i)
                        .split(".")
                        .pop();
                  if (!n) return;
                  const r =
                    e.collection.options.repeaterFieldModel.id +
                    "." +
                    n +
                    "_" +
                    t;
        ...
        return Marionette.LayoutView.extend({
          ...
          onShow: function() {
            ...
            var i = this.model.get("formContentData"),
              ...
              o = _.first(r);
            formContentView = o();
            var l = { data: i, formModel: this.model };
            !1 != i instanceof Backbone.Collection
              ? (l.collection = i)
              : !1 != i instanceof Backbone.Model && (l.model = i),
              this.formContent.show(new formContentView(l)),
      ...
      (this.numberDecoder = function(e) {
        ...
        switch (r.length) {
          ...
          case 2:
            var l,
              a = r[0];
            (l = "." === a ? new RegExp("[.]", "g") : new RegExp(a, "g")),
              (t = e.replace(l, ""));
            var s,
              d = r[1];
            ...
            var l = Marionette.Application.extend({
              ...
              onStart: function() {
                ...
                _.each(e.models, function(e, t) {
                  var i = new o({ model: e, fieldCollection: e.get("fields") });
